...
srcdir = .
topdir = /Users/KEdgette1/.rvm/rubies/ruby-2.4.1/include/ruby-2.4.0
hdrdir = $(topdir)
arch_hdrdir = /Users/KEdgette1/.rvm/rubies/ruby-2.4.1/include/ruby-2.4.0/x86_64-darwin16
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/KEdgette1/.rvm/rubies/ruby-2.4.1
...
ldflags  = -L. -fstack-protector -L/usr/local/opt/libyaml/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/libksba/lib -L/usr/local/opt/openssl@1.1/lib
...
ORIG_SRCS = cfixedarray.c
SRCS = $(ORIG_SRCS) 
OBJS = cfixedarray.o
HDRS = 
LOCAL_HDRS = 
TARGET = CFixedArray
TARGET_NAME = CFixedArray
